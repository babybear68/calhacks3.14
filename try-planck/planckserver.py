...
categories = {'food':['american','mexican','asian','mediterranean'], 'sport':['basketball', 'football', 'soccer', 'tennis'], 'public_events':['talk','concert','exhibition','game'],'art_and_creativity':['music','reading_and_writing','painting','poetry']}
...
user7.labels = {"exhibition": 2/3, "asian": 1, "soccer": 2/3}
...
user16.labels = {"american": 1, "tennis": 2/3, "exhibition": 2/3}
...
user19.labels = {"basketball": 1/3, "asian": 1, "poetry": 1, "music": 1, "talk": 1, "exhibition": 2/3}

user20 = User("Sangyeon", "Freshman", 18, "Female")
user20.labels = {"painting": 1, "asian": 1, "music": 2/3, "exhibition": 2/3, "tennis": 2/3}
...
event2 = Event(user2,"Berkeley Eye",("exhibition", 1/2),"Nov 6 10:30 am","Berkeley Art Museum and Pacific Film Archive","Appreciating the art collection at BAMPFA.",(2,3),True)
...
event20 = Event(user20, "Modern Art Exhibition at Berkeley Museum", ("exhibition", 1/3), "Nov 20 9:00 am", "Berkeley Museum", "Modern art is the best.", (2, 4), False)
