...
#create users
user1 = User("BigBear", "Senior", 22, "Male")
user1.labels = {"tennis": 1/3, "concert": 2/3, "talk": 1}

user2 = User("Elena", "Freshman", 18, "Female")
user2.labels = {"tennis": 2/3, "music": 1, "reading_and_writing": 2/3, "asian":1, "game": 1}

user3 = User("Henry", "Freshman", 18, "Male")
user3.labels = {"basketball": 1, "mexican": 1/3, "music": 2/3, "concerts": 2/3}
...
results = []
for user in users:
    event = Event(user1,'lol', ('music', 1/3), None, None, '', (1,3))
    results.append(Calculator.calculate(event, user))
print(set(results))
